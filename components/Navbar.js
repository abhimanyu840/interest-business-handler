                ...
                <header className="text-gray-600 body-font shadow-md">
                    <div className="container mx-auto flex flex-wrap p-4 flex-col md:flex-row ">
                        <div className='flex justify-between'>
                            ...
                            </Link><HiMenu className='text-3xl font-extrabold text-black mx-2 md:hidden' onClick={toggleClick} /></div>
                        <nav ref={ref} className="md:ml-auto hidden md:flex flex-col md:flex-row  items-center text-base justify-center" onClick={toggleClick}>
                            ...
                            {!user.id && <Link href="/login"><div className="flex cursor-pointer mx-auto ml-auto text-white bg-red-900 text-sm border-0 p-1 py-1.5 mt-2.5 md:mt-0 px-4 md:mx-1 focus:outline-none hover:bg-red-500 hover:text-gray-700 rounded font-ubuntu font-semibold">LogIn</div></Link>}{
                                !user.id && <Link href="/signup"><div className="flex cursor-pointer mx-auto ml-auto text-white bg-red-900 text-sm border-0 p-1 py-1.5 mt-2.5 md:mt-0 px-4 md:mx-1 focus:outline-none hover:bg-red-500 hover:text-gray-700 rounded font-ubuntu font-semibold">SignUp</div></Link>}
                            {/* {console.log(cookies.id)} */}
                            {user.id && <div className="flex cursor-pointer mx-auto ml-auto text-white bg-red-900 text-sm border-0 p-1 py-1.5 mt-2.5 md:mt-0 px-4 md:mx-1 focus:outline-none hover:bg-red-500 hover:text-gray-700 rounded font-ubuntu font-semibold" onClick={handleClick}>Logout</div>
                            }
