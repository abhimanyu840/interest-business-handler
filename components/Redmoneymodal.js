...
const Redmoneymodal = ({ closeModal }) => {
    return (
        <>
            <div className='container shadow-xl rounded-lg absolute min-w-5/6 align-center bg-white min-h-screen'>
                ...
                <div className="mx-4 p-3">
                    ...
                    <div className="form-group mb-6">
                        ...
                        <input type="number" className="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="rmoney" placeholder="Amount to be reduced" />
                    </div>
                    <div className="form-group mb-6">
